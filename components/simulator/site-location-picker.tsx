...
export function SiteLocationPicker({
  ...
  return (
    <div className="w-full max-w-[18.5rem] min-w-0 sm:w-[20rem] sm:max-w-none lg:w-[21rem]" data-testid="site-location-picker">
      ...
      <div className="grid grid-cols-2 gap-1.5">
        <select
          ...
          disabled={disabled}
          className="min-h-9 w-full min-w-0 rounded-lg border border-line bg-white px-2.5 text-[0.82rem] text-ink disabled:cursor-not-allowed disabled:opacity-50 sm:text-[0.9rem]"
        ...
        <select
          ...
          className="min-h-9 w-full min-w-0 rounded-lg border border-line bg-white px-2.5 text-[0.82rem] text-ink disabled:cursor-not-allowed disabled:bg-sand/50 disabled:text-muted disabled:opacity-70 sm:text-[0.9rem]"
