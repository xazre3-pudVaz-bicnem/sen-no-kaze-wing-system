...
export const foldingTech = {
  title: '経験から生まれた傾斜地対応方式採用\n折畳み木造コンテナ',
  badge: '特許出願中',
  body: '災害時に早く安心できる住まいを届けるため、傾斜地でも造成を最小限に抑えられる構造、狭い道路でも運びやすい折畳み構造、普段の住まいに近い木造にこだわりました。コストを抑え、スピーディーに設置できる木造コンテナです。',
};
...
export const showcase = {
  ...
  products: [
    ...
    },
    {
      ...
      images: [
        { src: '/images/products/box-building-cutout.png', alt: '伸縮可能な設置足の上に建つ白い外壁の BOX' },
        { src: '/images/plan/box-interior-layout-cutout.png', alt: '3点ユニットバス・キッチン・ベッドを収めた BOX の内装レイアウト' },
      ],
      topics: [
        {
          tag: '土地活用例',
