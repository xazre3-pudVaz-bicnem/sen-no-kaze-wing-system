...
export const metadata = buildMetadata({
  title: '千の風プロジェクト｜世界初⁉傾斜地対応 折畳み式木造コンテナ Wing・BOX・Flat',
  description:
    '世界初⁉傾斜地対応の折り畳み式木造コンテナ（特許出願中）。確認申請・住宅ローンに対応し、傾斜地にも最小限の造成で設置。Wing・BOX・Flatの3商品と組合せプランを、見積シミュレーターで概算確認できます。',
  path: '/',
  image: '/og-image.jpg',
  keywords: ['傾斜地対応', '折り畳み式コンテナ', '木造コンテナ', 'コンテナホテル', 'コンテナハウス', '宿泊事業', '遊休地活用', '傾斜地', 'Wing', 'BOX', 'Flat', '千の風プロジェクト', '技術の杜'],
});
